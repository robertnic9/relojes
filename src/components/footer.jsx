  ...
  return (
    <footer className="w-full bg-white shadow-[0_-4px_8px_-2px_rgba(0,0,0,0.1)]">
      <div className="max-w mx-auto py-4">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 px-8 sm:grid-cols-2 md:px-24 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="mt-12">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/watches" className="hover:underline">
                  Todos Los Relojes
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/boutiques" className="hover:underline">
                  Buscar una boutique
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-wrap justify-center md:justify-end  mt-12 pt-4 border-t border-gray-200 text-center ">
          <ul className="grid grid-cols-1 sm:grid-cols-2 md:flex md:pr-12 gap-4 md:gap-24">
            <li>
              <a href="#" className="hover:underline">
                Prensa
              </a>
